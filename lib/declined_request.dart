...
class _DeclinedRequestsState extends State<DeclinedRequests>
  ...
  final requestController = Get.find<RequestAdminController>(); // UNCOMMENTED
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: () {
                        ...
                        // Optional: Add functionality to move back to pending
                        // requestController.moveToPending(request);
                      },
                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () {
                        Navigator.pop(context);
                        requestController
                            .approveRequest(request); // Move to approved
                      },
            ...
            children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(() => Text(
                                // UNCOMMENTED
                                "${requestController.declinedRequests.length} declined", // FIXED PROPERTY NAME
                                style: TextStyle(
              ...
              Expanded(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      // REPLACE temporary placeholder with this:
                      Expanded(
                        child: Obx(() {
                          if (requestController.declinedRequests.isEmpty) {
                          ...
                          return GridView.builder(
                            ...
                            itemCount:
                                requestController.declinedRequests.length,
                            itemBuilder: (context, index) {
                              final request =
                                  requestController.declinedRequests[index];
  ...
  Widget _buildAnimatedRequestCard(ExeatRequest request, int index) {
    ...
    return AnimatedBuilder(
      ...
      child: GestureDetector(
        onTap: () => _showRequestDetails(request), // ADDED TAP TO SEE DETAILS
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
