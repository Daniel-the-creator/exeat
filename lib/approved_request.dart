                  ...
                  Expanded(
                    child: ElevatedButton.icon(
                      onPressed: () {
                        Navigator.pop(context);
                        requestController
                            .declineRequest(request); // Move to declined
                      },
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(() => Text(
                                // UNCOMMENTED
                                "${requestController.approvedRequests.length} approved", // FIXED PROPERTY NAME
                                style: TextStyle(
                      ...
                      Expanded(
                        child: Obx(() {
                          ...
                          return GridView.builder(
                            ...
                            itemCount:
                                requestController.approvedRequests.length,
                            itemBuilder: (context, index) {
                              final request =
                                  requestController.approvedRequests[index];
